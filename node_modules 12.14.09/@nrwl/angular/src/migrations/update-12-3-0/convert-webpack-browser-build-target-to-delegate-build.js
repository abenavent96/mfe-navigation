    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const [projectName, project] of projects) {
            ...
            for (const target of webpackBrowserTargets) {
                ...
                const buildTargetName = yield getBuildTargetNameFromOptions(target.options, configurationOptions);
                if (buildTargetName) {
                    target.executor = '@nrwl/angular:delegate-build';
                    updateTargetsOptions(project, target, buildTargetName);
                    yield updateTargetsConfigurations(project, projectName, target, buildTargetName, configurationOptions);
                }
            }
...
function extractConfigurationBuildTarget(project, target, configuration, buildTarget) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (buildTarget) {
            const buildTargetObj = (0, devkit_1.parseTargetString)(buildTarget, yield (0, devkit_1.createProjectGraphAsync)());
...
function getBuildTargetNameFromOptions(baseOptions, configurationOptions) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const pg = yield (0, devkit_1.createProjectGraphAsync)();
        if (baseOptions.buildTarget) {
            return (0, devkit_1.parseTargetString)(baseOptions.buildTarget, pg).target;
        }
        for (const [, options] of configurationOptions) {
            if (options.buildTarget) {
                return (0, devkit_1.parseTargetString)(options.buildTarget, pg).target;
            }
        }
    });
}
...
function updateTargetsConfigurations(project, projectName, target, buildTargetName, configurationOptions) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        for (const [configurationName, options] of configurationOptions) {
            ...
            const configurationBuildTarget = yield extractConfigurationBuildTarget(projectName, buildTargetName, configurationName, buildTarget);
